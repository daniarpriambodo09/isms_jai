...
// Admin only — rename a camera control code or reassign its department.
export async function PUT(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    await query('UPDATE camera_equipment SET code = $1, department_id = $2 WHERE id = $3', [code, departmentId, id])
