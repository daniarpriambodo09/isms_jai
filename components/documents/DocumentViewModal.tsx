...
export function DocumentViewModal({
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-[rgba(14,34,53,0.5)] p-4">
      <div role="dialog" aria-modal="true" aria-label={fileName} className="flex h-[85vh] w-full max-w-[900px] flex-col rounded-2xl bg-white shadow-[0_20px_50px_rgba(14,34,53,0.25)]">
